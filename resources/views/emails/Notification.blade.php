...
<html lang="sk" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; font-size: 15px;"><span
                                                                                style="font-size:15px;">Blíži sa dátum
                                                                                splnenia jednej z Vašich naplánovaných
                                                                                úloh. </span></p>
                                                                        <p style="margin: 0; font-size: 15px;"><span
                                                                                style="font-size:15px;">Prihláste sa do
                                                                                aplikácie a zistite viac
                                                                                informácií. </span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; font-size: 12px;">Názov
                                                                            úlohy: {{ $task_name }}</p>
                                                                        <p style="margin: 0; font-size: 12px;">Dátum
                                                                            splnenia: {{ $task_next_date }}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; font-size: 14px;"><span
                                                                                style="font-size:11px;">Tento email bol
                                                                                automaticky zaslaný zo systému <a
                                                                                    href="{{ env('APP_URL') }}"
                                                                                    rel="noopener noreferrer"
                                                                                    style="color: #0068A5;"
                                                                                    target="_blank">{{ env('APP_NAME') }}</a> -
                                                                                prosím neodpovedajte na neho.</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
